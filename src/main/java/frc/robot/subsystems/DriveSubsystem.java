  ...
  public DriveSubsystem() {
    AutoBuilder.configureHolonomic(
                ...
                new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
                        new PIDConstants(2.5, 0.0, 0.1), // Translation PID constants
                        new PIDConstants(1.5, 0.0, 0.1), // Rotation PID constants
                        3, // Max module speed, in m/s
                        Math.sqrt(Math.pow(Units.inchesToMeters(25.5), 2)+Math.pow(Units.inchesToMeters(25.5),2))/2, // Drive base radius in meters. Distance from robot center to furthest module.
